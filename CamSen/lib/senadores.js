          jQuery(function ($)
        {
	var bancaCamaraBaja = camaraBaja.div.circle(410.000001, 200.499999, 5.070313 );

            bancaCamaraBaja.attr({ fill: 'red', stroke: 'black', 'stroke-width': 1, 'stroke-linejoin': 'round' });
	
			$(bancaCamaraBaja.node).qtip({ content: 
{ text: '<img src=imagenes/DipEricCalcagnoyMaillman.jpg style=display: none /><br/>ERIC CALCAGNO Y MAILLMAN <br/>Alianza Frente para la Victoria</a>'},
        ...
        /*************************************OLD CODE*************************************************************************/
        /*var camaraAltaDiv= new Raphael(document.getElementById('canvas_container'), 800,800);
				...
				var bancaCamaraAlta = camaraAlta.div.circle(110.000001, 227.499999, 5.070313 );
            ...
            bancaCamaraAlta.attr({ fill: 'blue', stroke: 'red', 'stroke-width': 1, 'stroke-linejoin': 'round' });
	
			$(bancaCamaraAlta.node).qtip({ content: 
